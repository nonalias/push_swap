...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/18 21:42:34 by taehkim           #+#    #+#             */
/*   Updated: 2021/03/18 21:45:14 by taehkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			msg_act_one(char *func_name,
		void (*act)(t_stack *), t_stack *a);
void			msg_act_two(char *func_name,
		void (*act)(t_stack *, t_stack *), t_stack *a, t_stack *b);
...
void			push_to_b_under_medium(t_stack *a, t_stack *b,
		int medium, int before);
